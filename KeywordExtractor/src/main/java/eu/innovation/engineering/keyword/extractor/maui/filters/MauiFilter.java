package eu.innovation.engineering.keyword.extractor.maui.filters;
...
public class MauiFilter extends Filter {
  ...
  private double[] computeFeatureValues(Candidate candidate,
    ...
    double tf = candidate.getTermFrequency()*100;
    double idf = -Math.log((globalVal + 1) / (numDocs + 1));
