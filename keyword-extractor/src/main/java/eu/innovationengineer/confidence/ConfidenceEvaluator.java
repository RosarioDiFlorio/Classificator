package eu.innovationengineer.confidence;
...
import eu.innovationengineer.services.KeywordRequest;
import eu.innovationengineer.services.KeywordRequester;
import eu.innovationengineer.services.KeywordResponse;
...
public class ConfidenceEvaluator extends SpringMainLauncher implements KeywordRequester, InitializingBean {
  ...
  public List<ConfidenceResult> getConfidences (String text,List<String> classList) throws Exception{   
    if(categoriesVector == null)
      categoriesVector = getCategoriesVector();
  ...
  @Override
  public KeywordResponse computeConfidence(KeywordRequest request) throws Exception {
    /* if(categoriesVector == null)
      categoriesVector = getCategoriesVector();*/
